...
// Generated on Wed Mar 23 2022 by `yarn update:icons`

import React from 'react';

export type IconTypeRegular =
  | '3d_rotation'
  | 'ac_unit'
  | 'access_alarm'
  | 'access_alarms'
...
export interface IconsDefaultRegular extends IconsDefaultCommons {
  icon: IconTypeRegular;
  display: 'regular';
}
